...
for (keyIndex in 1:nrow(statsPOS)) {
  ...
  #Buscamos terminos que contengan a nuestro candidato. Tarda o.2 segundos de media por iteracción. 
  coincidencias <- statsPOS[grepl(candidate ,statsPOS$keyword), ]$keyword
