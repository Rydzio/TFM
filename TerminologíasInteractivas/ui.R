  ...
  fluidRow(navbarPage(id = "inNavbar", title = strong("TermInteract"), 
                      ...
                      tabPanel("Gestor de documentos", value = "add", icon = icon("folder-open"),
                               ...
                               fluidRow(
                                 ...
                                 column(6,
                                        fluidRow(h4(strong(textOutput("docSelected")))),
                               ...
                               fluidRow(
                                 column(12, 
                                        wellPanel(
                                          fluidRow(
                                            column(6, h4(strong("Crear un nuevo corpus"))),
                                            column(6, textInput("nameCorp", label = NULL, placeholder = "Nombre del nuevo corpus"))),
