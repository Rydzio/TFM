...
docs <- readtext(paste0(getwd(), ruta), #Leo todo lo que tenga ese path
                 ...
                 #dvsep = "_", 
                 #encoding = "ISO-8859-1", #Casi mejor no pongo nada porque no s̩ el encoding
                 verbosity = 0) 
...
Limpiamos los textos extraidos
```{r}
library(stringr)

#Si fuera necesario, hay que limpiar los textos extraidos de los documentos
...
tic()
x <- udpipe(t2, path, parallel.cores = 16)
toc()

#saveRDS(x, file = "airbus.rds")
